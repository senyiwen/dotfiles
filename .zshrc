...
# iuload a random theme each time oh-my-zsh is loaded, in which case,
...
alias pide='open -na "PhpStorm.app" --args'
alias wide='open -na "WebStorm.app" --args'
#docker
...
alias gcm='git checkout main && git pull --rebase && git checkout -'
